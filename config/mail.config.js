                      ...
                      <tr>
                        <td class="content-cell" style="word-break: break-word; font-family: 'Nunito Sans', Helvetica, Arial, sans-serif; font-size: 16px; padding: 45px;">
                          <div class="f-fallback">
                            ...
                            <p style="margin: .4em 0 1.1875em; font-size: 16px; line-height: 1.625; color: #51545E;">Recientemente te has registrado en nuestra web, para acceder a ella tienes que confirmar tu email. Pulse el botón a continuación para la confirmación. <strong>Solo puede realizar esta confirmación durante las siguientes 24 horas</strong></p>
                            <!-- Action -->
