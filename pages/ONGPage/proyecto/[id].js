...
const Post = ({proyectos, donaciones}) => {
    ...
    return (
        ...
        className='w-full flex flex-col h-screen bg-gray-100'>
            <Link href="/ONGPage"><button className='w-full py-3 bg-green-800 hover:bg-green-900 flex justify-center items-center text-2xl text-white'><BsFillArrowUpCircleFill /></button></Link>
